...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private String name,email,image,post,uniqueKey,category,downloadurl;
    ...
    private void updateData(String s) {
        ...
        reference.child(category).child(uniqueKey).updateChildren(up).addOnSuccessListener(new OnSuccessListener() {
            @Override
