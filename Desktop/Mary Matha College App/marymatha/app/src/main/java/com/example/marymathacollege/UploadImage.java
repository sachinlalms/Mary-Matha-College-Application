...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Convocation", "Freshers Day", "Independence Day", "Teachers Day", "Onam", "Gandhi Jayanthi", "Christmas", "Republic Day", "College IV", "NSS Day", "NCC Day", "College Fest", "Other Event"};
